...
namespace TestXWinkel
{
    public class UnitTest1
    {
        ...
        public void TestGetCustomersAddCustomer()
        {
            ...
            Assert.Equal(aantalVoor + 1, customersNa.Count);

            Assert.Contains(customer, customersNa);
        ...
        public void TestGetOrdersAndAddOrderWithDetails()
        {
            ...
            Assert.Equal(ordersVoor.Count + 1, ordersNa.Count);
            ...
            Assert.Equal(orderToeTeVoegen, orderUitDatabankGehaald);
